...
@Database(entities = {Product.class, Cart.class, Order.class, Category.class, Banner.class}, version = 2)
    ...
    public static synchronized AppDatabase getInstance(Context context) {
        if (instance == null) {
            instance = Room.databaseBuilder(context.getApplicationContext(),
                            AppDatabase.class, "shopping_db").fallbackToDestructiveMigration()
